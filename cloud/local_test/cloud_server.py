...
localhost_heartbeat_port = 'tcp://localhost:63270'
localhost_data_port = 'tcp://localhost:63271'
localhost_plz_port = 'tcp://localhost:63272'
...
async def receive_heartbeat():
    ...
    with pynng.Rep0() as heartbeat_socket:
        heartbeat_socket.listen(localhost_heartbeat_port) # needs to be adjusted according to local component.
...
async def receive_data():
    ...
    with pynng.Sub0() as data_socket:
        data_socket.listen(localhost_data_port) # needs to be adjusted according to local component.
...
async def plz_data(id):
    ...
    with pynng.Pub0() as ack_socket:
        try:
            ack_socket.dial(localhost_plz_port)    # needs to be adjusted according to local component.
